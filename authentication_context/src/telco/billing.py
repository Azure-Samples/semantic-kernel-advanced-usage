...
billing_agent = ChatCompletionAgent(
    ...
    Your tasks are:
    - Check the user has been authenticated before proceeding.
    ...
    - You MUST ensure the 'user-id' context variable is set before proceeding. You CANNOT proceed without it.
    """,
)
